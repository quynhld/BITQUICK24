<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminSite.Master" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="bitquick.Admin.Dashboard" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <%--<div class="">
        <div class="title_form_db">
            <p>
                Đã thanh toán <span class="badge">
                    <asp:Label runat="server" ID="lblThanhToan" Text="5"></asp:Label></span> BTC / còn lại <span class="badge">
                        <asp:Label runat="server" ID="Label1" Text="10"></asp:Label>
                    </span>BTC
            </p>
        </div>
    </div>--%>
